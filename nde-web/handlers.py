    ...
    def extras(self, _meta):
        source_info = {
            ...
            "veupath_collections": {
                ...
                "description": "VEuPath Collections is the collection of component websites of the Eukaryotic Pathogen, Vector and Host Informatics Resource (VEuPathDB) that have been constructed using the same infrastructure, data analysis, and loading procedures. VEuPathDB is one of two bioinformatics Resource Centers (BRCs) funded by the US National Institute of Allergy and Infectious Diseases (NIAID), with additional support from the Wellcome Trust (UK). The VEuPath Collections include the following component websites as individual collections:\n* AmoebaDB\n* CryptoDB\n* GiardiaDB\n* HostDB\n* PlasmoDB\n* VectorBase\n* FungiDB\n* MicrosporidiaDB\n* ToxoDB\n* TrichDB\n* TriTrypDB\n* PiroplasmaDB",
                "schema": {
                    "id": "identifer",
                    "displayName": "name",
                    "contact_name": "author",
